    ...
    <div id="contact" class="container animate__animated animate__fadeIn animate__delay-0.5s">
        ...
        <p>
            ...
            <ul>
                ...
                <li>Facebook: <a href="https://facebook.com/justharveyy">justharveyy</a></li>
                <li>Phone: +84904177537</li>
                <li>Email: <a href="mailto:hoang.nicolas2409@gmail.com">hoang.nicolas2409@gmail.com</a></li>
            </ul>
        </p>
    </div>
</template>
